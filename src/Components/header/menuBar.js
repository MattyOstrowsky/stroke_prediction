    ...
    return (
        <Toolbar variant="dense">
            ...
            <Typography className={classes.root}>
                <Button className={classes.linkButton} component={Link} to='/About'>About</Button>
            </Typography>
            <Typography className={classes.root}>
            ...
            <Typography className={classes.root}>
                <Button className={classes.linkButton} component={Link} to='/strokemodel'>Stroke prediction</Button>
            </Typography>
        </Toolbar>
    );
}