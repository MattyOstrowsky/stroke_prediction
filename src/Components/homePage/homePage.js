...
export default function Section() {
  ...
  const [projectList, setProjectList] = useState([])
    ...
    useEffect(() => {
      axios.get('https://stark-gorge-14911.herokuapp.com/')
      .then (res => {
        ...
        <Paper elevation={3}>
          ...
          >
            <IconButton size='small' onClick={() => {
              ...
              }}><GitHubIcon className={classes.iconsize} />GitHub</IconButton>
            <IconButton size='small' onClick={() => {
                window.location.href = 'https://www.linkedin.com/in/mateusz-ostrowski-94750918a/';
              }}><LinkedInIcon className={classes.iconsize} />LinkedIn</IconButton>
            <IconButton size='small' onClick={() => {
                window.location.href = 'https://www.kaggle.com/gunater';
              }}><ClassIcon className={classes.iconsize} />Kaggle</IconButton>
          </Grid>
          ...
          <Grid container
            ...
            alignItems="center"
            display="flex" >
            <Button className={classes.button} size="large" variant="outlined" color="primary" href="/">
              Show more about me...
            </Button>
          </Grid>
          <Grid
